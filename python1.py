...
def nine(input):
	...
	for i in range(0,x-1):
		 l.append(n[i+1])
	return l
print(nine("assbertasabertassdbertsdsdbert"))
#------------------------------------------------------------------------------------------------------------------------------------------------------------------ 
